...
EzExp.Timer = function() {
  ...
  */
  ...
  /** Cancel the timer. Reset its time and put it in {@link EzExp.Enums.TimerState.NotStarted|NotStarted} state.
  */
  this.cancel = function() {
    that._startTime = 0;
    that._temporalState = EzExp.Enums.TimerState.NotStarted;
  }
