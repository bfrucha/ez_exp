...
EzExp.Experiment = function (ifp, pid, pcn, tid) {
  ...
  */
  this.getTrial = function(index) {
    if (index < 0 || this._trials.length <= index) { return null; }
  ...
  */
  this.setRecordBehavior = function(behavior) { this._recordBehavior = behavior; }
  ...
  */
  this.saveCurrentTrial = function() {
    ...
    try {
      fs.appendFileSync(this._outputFilePath, data+'\n', 'utf8');
