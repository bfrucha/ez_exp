var fs = require('fs');
var trial = require('ez_exp/trial');
var enums = require('ez_exp/enum.js');


module.exports.loadExperiment = function (inputFilePath, participantId, participantColName='Participant', trialId = 0) {
  var exp = (function (ifp, pid, tid, pcn) {
    ...
    var _recordBehavior = enums.RecordBehavior.SaveOnTrialEnd;
    ...
    return {
      ...
      endTrial: function() {
        ...
        if(t) {
          t.endTrial();
          if(_recordBehavior == enums.RecordBehavior.SaveOnTrialEnd) { this.saveCurrentTrial(); }
...
// TO REMOVE
module.exports.createTrial = trial.createTrial;
